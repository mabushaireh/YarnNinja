...
namespace YarnNinja.CommonTests
{
    ...
    public class YarnApplicationContainerTests : BaseCommonTest
    {
        ...
        [DataRow("launch_container.sh", 55, DisplayName = "Correct Container Logs By launch_container.sh")]
        ...
        [DataRow("syslog", 110, DisplayName = "Correct Container Logs By syslog")]
        [DataRow("syslog_dag_1639352826059_8646_1", 11833, DisplayName = "Correct Container Logs By syslog_dag_1639352826059_8646_1")]
        ...
        [DataRow("syslog_dag_1639352826059_8646_2_post", 42, DisplayName = "Correct Container Logs By syslog_dag_1639352826059_8646_2_post")]
        [DataRow("syslog_dag_1639352826059_8646_3", 297, DisplayName = "Correct Container Logs By syslog_dag_1639352826059_8646_3")]
        ...
        [DataRow(LogType.launch_container_sh, 55, DisplayName = "Correct Container Logs By Type launch_container_sh")]
        ...
        [DataRow(LogType.syslog, 12450, DisplayName = "Correct Container Logs By syslog")]
