...
namespace YarnNinja.CommonTests
{
    ...
    public class YarnApplicationContainerTests : BaseCommonTest
    {
        ...
        [DataRow("dag_1639352826059_8646_1.dot", 83, DisplayName = "Correct Container Logs By Type dag_1639352826059_8646_1.dot")]
        [DataRow("dag_1639352826059_8646_2.dot", 23, DisplayName = "Correct Container Logs By Type dag_1639352826059_8646_2.dot")]
        [DataRow("dag_1639352826059_8646_3.dot", 99, DisplayName = "Correct Container Logs By dag_1639352826059_8646_3.dot")]
        [DataRow("directory.info", 377, DisplayName = "Correct Container Logs By directory.info")]
        [DataRow("launch_container.sh", 111, DisplayName = "Correct Container Logs By launch_container.sh")]
        [DataRow("prelaunch.out", 7, DisplayName = "Correct Container Logs By prelaunch.out")]
        [DataRow("stderr", 9, DisplayName = "Correct Container Logs By stderr")]
        [DataRow("stdout", 935, DisplayName = "Correct Container Logs By stdout")]
        ...
        [TestMethod()]
        [DataRow(LogType.directory_info, 377, DisplayName = "Correct Container Logs By Type directory_info")]
        [DataRow(LogType.launch_container_sh, 111, DisplayName = "Correct Container Logs By Type launch_container_sh")]
        [DataRow(LogType.prelaunch_err, 0, DisplayName = "Correct Container Logs By Type prelaunch_err")]
        [DataRow(LogType.stderr, 9, DisplayName = "Correct Container Logs By stderr")]
        [DataRow(LogType.stdout, 935, DisplayName = "Correct Container Logs By stdout")]
        [DataRow(LogType.syslog, 12057, DisplayName = "Correct Container Logs By syslog")]
        [DataRow(LogType.prelaunch_out, 7, DisplayName = "Correct Container Logs By prelaunch.out")]
        [DataRow(LogType.DAG, 205, DisplayName = "Correct Container Logs By DAG")]
